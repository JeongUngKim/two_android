...
public interface CommunityApi {
    ...
    @Multipart
    @POST("community")
    Call<HashMap<String,String>> createCommunity(@Header("Authorization") String token,
    ...
    @Multipart
    @POST("community")
    Call<HashMap<String,String>> createCommunityNoImage(@Header("Authorization") String token,
                                                 @Part("title") RequestBody title ,
                                                 @Part("content") RequestBody content);
    // 커뮤니티 글 수정 (이미지 포함)
    @Multipart
